  ...
  return (
    <section className="container grid max-w-screen-2xl items-center gap-12 py-16 md:grid-cols-2 md:py-24">
      <div className="space-y-6 text-center md:text-left">
        <h1 className="from-foreground via-foreground/90 to-foreground/70 bg-gradient-to-br from-30% bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl lg:text-6xl">
          IT Solutions for the Modern Business
        </h1>
        <p className="text-muted-foreground mx-auto max-w-[36rem] leading-normal sm:text-lg sm:leading-8 md:mx-0">
